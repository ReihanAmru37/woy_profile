...
<div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <div class="wrapper-img-coba">
            <img src="/img/coba.jpg" class="wrapper-img-coba" alt="">
        </div>
        <div class="container">
          <div class="carousel-caption text-start">
            <h1>Woy Studio</h1>
            <p>Membantu anda untuk menjangkau lebih jauh.</p>
    ...
    <div class="container px-4 py-5 text-center" id="icon-grid">
      <h2 class="pb-2 border-bottom">Fitur Yang Kami Sediakan</h2> 
  ...
  <div class="container px-4 py-5 text-center" id="icon-grid">
    <h2 class="pb-2 border-bottom">Desain Yang Kami Sediakan</h2>
...
<div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
  ...
  <div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3" style="width: 50%">
    <div class="bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden" style="width: 50%">
      <div class="my-3 p-3">
        <h2 class="display-5">Another headline</h2>
        <p class="lead">And an even wittier subheading.</p>
    ...
    <div class="bg-primary me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden" style="width: 50%">
      <div class="my-3 py-3">
        <h2 class="display-5">Another headline</h2>
        <p class="lead">And an even wittier subheading.</p>
      </div>
...
<div class="container px-4 py-5 text-center" id="icon-grid">
  <h2 class="pb-2 border-bottom">Paket Yang Kami Sediakan</h2>
